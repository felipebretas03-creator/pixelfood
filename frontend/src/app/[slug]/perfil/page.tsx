      ...
      <div className="px-6 flex flex-col gap-6">
        ...
        <div>
          ...
          <div className="bg-white rounded-3xl border border-stone-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] overflow-hidden">
            ...
            <Link href={`/${slug}/perfil/ajuda`} className="w-full flex items-center justify-between p-4 border-b border-stone-50 hover:bg-stone-50 transition-colors text-left">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-stone-50 flex items-center justify-center text-stone-600">
            ...
            <button onClick={() => { logout(); router.push(`/${slug}/`); }} className="w-full flex items-center justify-between p-4 hover:bg-red-50 transition-colors text-left group">
              <div className="flex items-center gap-4">
